// src/main/java/my/nexgenesports/controller/ProgramCancelServlet.java
...
@WebServlet("/programs/cancel")
public class ProgramCancelServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
        try {
            ...
            Logger.getLogger(ProgramCancelServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
